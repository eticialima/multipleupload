...
from manuais.views import (carrosDeleteView, carrosIndexView, carrosListView, carrosNewView, carrosUpdateView, ManuaisDeleteView, ManuaisIndexView, ManuaisListView, ManuaisNewView, ManuaisUpdateView)
from manuais.views import ArquivosCreate, JSONListView, JSONDetailView, JSONUpdate, JSONDelete

# app_name = "equipment"

urlpatterns = [
	path('', carrosIndexView.as_view(), name='index-carros'),
	path('carros/', carrosListView.as_view(), name='carros'), 
